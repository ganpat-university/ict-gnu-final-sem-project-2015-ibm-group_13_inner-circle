...
public class CartBean {
	 ...
	 public void deleteCartItem(String strItemIndex) {
	  int iItemIndex = 0;
	  try {
		  System.out.println("Inside CartBean:deleteCartItem---------\nItem Index:"+strItemIndex);
	 ...
	 public void deleteAllCartItem(String strItemIndex) {
		  int iItemIndex = 0,i=0;
//		  System.out.println("**Inside CartBean-\n******deleteAllCartItem\n");
		  try {
//			System.out.println("Item Index:::"+strItemIndex);
//			  System.out.println("Items are::");
		   //iItemIndex = Integer.parseInt(strItemIndex);
			  alCartItems.clear();
			  calculateOrderTotal();
//		   while(alCartItems.size() != 0) {
//			   {
//			   System.out.println("Item"+i+" :"+alCartItems.get(i));
//			   i++;
//			   }
//		   	   calculateOrderTotal();
//		   }
		  } catch(NumberFormatException nfe) {
		   System.out.println("Error while deleting all cart item: "+nfe.getMessage());
		   nfe.printStackTrace();
		  }
		 }
